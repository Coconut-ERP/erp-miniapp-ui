...
Inline status message on a page.

## Import

```ts
import { Alert, AlertTitle, AlertDescription, AlertAction } from "@erp/miniapp-ui";
```
...
Public exports: `Alert, AlertTitle, AlertDescription, AlertAction`.
