...
```ts
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, CardAction } from "@erp/miniapp-ui";
```
...
Public exports: `Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, CardAction`.
