...
Rich preview content shown on hover or focus.

## Import

```ts
import { HoverCard, HoverCardTrigger, HoverCardContent } from "@erp/miniapp-ui";
```
...
Public exports: `HoverCard, HoverCardTrigger, HoverCardContent`.
