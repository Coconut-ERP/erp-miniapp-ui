...
Empty-state layout for lists and panels.

## Import

```ts
import { Empty, EmptyHeader, EmptyMedia, EmptyTitle, EmptyDescription, EmptyContent } from "@erp/miniapp-ui";
```
...
Public exports: `Empty, EmptyHeader, EmptyMedia, EmptyTitle, EmptyDescription, EmptyContent`.
