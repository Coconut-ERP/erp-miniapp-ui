...
<Meta title="Patterns/Dashboard" />

# Dashboard

## Composition

Grid of `StatisticCard` + `DashboardCard` panels. Charts: `BarChart` / `DonutChart` / `LineChart` — pass data only (see [chart-page recipe](/?path=/docs/recipes-chart-page--docs)).
